<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="BgtPlans.aspx.cs" Inherits="BMSWeb.Pages.BgtPlans" %>
											...
											<ItemTemplate>
												...
												<p style="white-space: nowrap; width: 250px; text-overflow: ellipsis; overflow: hidden;">
													<asp:LinkButton ID="btnDes" Height="18px" CssClass="vertical-align-mid" Text='<%#Eval("DESCRIPTION") %>' runat="server"
														CommandName="viewDes" ToolTip='<%#Eval("DESCRIPTION") %>' CommandArgument='<%#GetCommandArgument(Eval("SER_NO"),Eval("DESCRIPTION"),Eval("JUSTIFICATION"),Eval("AMOUNT")) %>' />
												</p>
											</ItemTemplate>
										</asp:TemplateField>
										...
										<asp:TemplateField>
											...
											<ItemTemplate>
												<asp:ImageButton ID="ImgBtndetail" CssClass="vertical-align-mid" ImageUrl="../assets/img/1477300661_circle-edit-article.png" Height="30" runat="server"
													CommandName="ViewDetail1" CommandArgument='<%#GetCommandArgument(Eval("SER_NO"),Eval("DESCRIPTION"),Eval("JUSTIFICATION"),Eval("AMOUNT")) %>' />
