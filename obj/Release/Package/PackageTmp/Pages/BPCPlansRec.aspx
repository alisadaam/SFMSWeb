<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="BPCPlansRec.aspx.cs" Inherits="BMSWeb.Pages.BPCPlansRec" %>
	...
	<div class="row" id="main_form" runat="server">
		...
		<div class="col-md-12 col-lg-12 padingRight5px" style="padding-left: 11px;">
			...
			<div class="col-lg-8 col-md-6">
				<h3 runat="server" style="color: #1D74D6; margin: 0px">Rec By Plans - <span runat="server" id="yearlabel"></span></h3>
			</div>
						...
						<asp:GridView ID="GridViewMainSummery" Width="100%" ShowFooter="true" CssClass="Grid table-hover border-color" AllowPaging="false" runat="server" OnRowDataBound="GridViewMainSummery_RowDataBound" AutoGenerateColumns="false" CellPadding="4">
							...
							<ItemTemplate>
								...
								<asp:TemplateField>
									...
									<ItemTemplate>
										<asp:Label runat="server" Font-Bold="true" Text='<%#Eval("REQ_AMT") %>' ForeColor="Red" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
								...
								<asp:TemplateField>
									...
									<ItemTemplate>
										<asp:Label runat="server" Font-Bold="true" Text='<%#Eval("PSO_AMT") %>' ForeColor="Green" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
								...
								<asp:TemplateField>
									...
									<ItemTemplate>
										<asp:Label runat="server" Font-Bold="true" Text='<%#Eval("PLANS_AMT") %>' ForeColor="OrangeRed" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
								...
								<%--<asp:TemplateField>
									...
									<ItemTemplate>
										<asp:Label runat="server" Font-Bold="true" Text='<%#Eval("SUPP_AMT") %>' ForeColor="#FF00D2" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									
								</asp:TemplateField>--%>
							<%--	<asp:TemplateField>
									<HeaderTemplate>BPC Rec Amt</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Font-Bold="true" Text='<%#Eval("BPC_REC_AMT") %>' ForeColor="BlueViolet" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
					...
					<div runat="server" id="MainDetails" class="box box-info col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px">
						...
						<div class="box-body">
								...
								<asp:GridView ID="GridEstimates" DataKeyNames="FY,DTE_SYMBOL1,SER_NO" AllowPaging="True" OnRowDataBound="GridEstimates_RowDataBound" ShowFooter="True" CssClass="Grid table-hover border-color" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="4" AllowSorting="True" OnRowCreated="GridEstimates_RowCreated" OnRowCommand="GridEstimates_RowCommand" OnPageIndexChanging="GridEstimates_PageIndexChanging">
									...
									<Columns>
										...
										<asp:TemplateField HeaderText="Rec By Plans">
											<ItemTemplate>
												<asp:TextBox ID="txtNewAMt"  AutoCompleteType="None" Font-Bold="true" CssClass="text-Align float-Right" onkeypress="return onlyNumbers();" AutoPostBack="true" runat="server" Width="60px" Height="25px" Text='<%# DataBinder.Eval(Container.DataItem, "AMOUNT_REC_PLANS") %>' OnTextChanged="txtNewAMt_TextChanged"></asp:TextBox>
											</ItemTemplate>
										</asp:TemplateField>
							...
							<div class="col-lg-12 col-md-12" style="text-align: right; padding-right: 5px">
								<asp:Button runat="server" CssClass="btn btn-primary btn-sm" Style="margin-top: 5px; padding-right: 5px" Text="Save" Visible="false" ID="BtnSave" OnClick="BtnSave_Click1" />
