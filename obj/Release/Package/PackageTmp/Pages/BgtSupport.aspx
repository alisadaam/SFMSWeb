<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="BgtSupport.aspx.cs" Inherits="BMSWeb.Pages.BgtSupport" %>
			...
			<div id="Div3" runat="server" class="col-md-7 col-lg-7 padingLeft5px" style="margin-top: -27px;">
				...
				<div runat="server" id="Div4" class="box box-info col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px; margin-bottom: 8px; top: 0px; left: 0px;">
					...
					<div class="box-body" style="padding-top: 2px">
						<asp:GridView ID="gvSummaryInfo" ShowFooter="true" CssClass="Grid table-hover border-color" Width="99%" AllowPaging="false" runat="server" AutoGenerateColumns="false" CellPadding="4" OnRowCreated="gvSummaryInfo_RowCreated">
							...
							<ItemTemplate>
								...
								<asp:TemplateField>
									...
									<FooterTemplate>
										<asp:Label runat="server" Text="Total (Amount in Million)" ID="lblTotal"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								<asp:TemplateField>
									<HeaderTemplate>COUNT</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Text='<%#Eval("REQ_CNT") %>' ForeColor="Red" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label runat="server" Text='<%# GetTotal("REQ_CNT")%>' ID="lblTotalReqCnt" CssClass="text-Align-span"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								<asp:TemplateField>
									<HeaderTemplate>AMT</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Text='<%#Eval("REQ_AMT") %>' ForeColor="Red" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label runat="server" Text='<%# GetTotal("REQ_AMT")%>' ID="lblREQ_AMT" CssClass="text-Align-span"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								...
								<asp:TemplateField>
									<HeaderTemplate>COUNT</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Text='<%#Eval("PLANS_CNT") %>' ForeColor="Green" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label runat="server" Text='<%# GetTotal("PLANS_CNT")%>' ID="lblPLANS_CNT" CssClass="text-Align-span"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								<asp:TemplateField>
									<HeaderTemplate>AMT</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Text='<%#"0"+Eval("PLANS_AMT") %>' ForeColor="Green" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label runat="server" Text='<%# GetTotal("PLANS_AMT")%>' ID="lblPLANS_AMT" CssClass="text-Align-span"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								...
								<asp:TemplateField>
									<HeaderTemplate>COUNT</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Text='<%#Eval("SUPP_CNT") %>' ForeColor="BlueViolet" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label runat="server" Text='<%# GetTotal("SUPP_CNT")%>' ID="lblSUPP_CNT" CssClass="text-Align-span"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								<asp:TemplateField>
									<HeaderTemplate>AMT</HeaderTemplate>
									<ItemTemplate>
										<asp:Label runat="server" Text='<%#Eval("SUPP_AMT") %>' ForeColor="BlueViolet" CssClass="text-Align-span"></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label runat="server" Text='<%# GetTotal("SUPP_AMT")%>' ID="lblSUPP_AMT" CssClass="text-Align-span"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
						...
						<div id="gridContainer">
							...
							<asp:GridView ID="GridEstimates" DataKeyNames="FY,DTE_SYMBOL,APPENDIX,SER_NO" AllowPaging="True" OnRowDataBound="GridEstimates_RowDataBound" ShowFooter="True" CssClass="Grid table-hover border-color" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="4" AllowSorting="True" OnRowCreated="GridEstimates_RowCreated" OnRowCommand="GridEstimates_RowCommand" OnPageIndexChanging="GridEstimates_PageIndexChanging">
								...
								<Columns>
										...
										<ItemTemplate>
											...
											<p style="white-space: nowrap; width: 250px; text-overflow: ellipsis; overflow: hidden;">
												<asp:LinkButton ID="btnDes" Height="18px" CssClass="vertical-align-mid" Text='<%#Eval("DESCRIPTION") %>' runat="server"
													CommandName="viewDes" ToolTip='<%#Eval("DESCRIPTION") %>' CommandArgument='<%#Eval("SER_NO") %>' />
											</p>
										</ItemTemplate>
									</asp:TemplateField>
									...
									<asp:TemplateField HeaderText="Rec By Supp">
										<ItemTemplate>
											<asp:TextBox ID="txtNewAMt" CssClass="text-Align" onkeypress="return onlyNumbers();" AutoPostBack="true" runat="server" Width="100%" Height="18px" Text='<%# DataBinder.Eval(Container.DataItem, "DCAS_SUP_REC") %>' OnTextChanged="txtNewAMt_TextChanged"></asp:TextBox>
										</ItemTemplate>
									</asp:TemplateField>
									...
									<asp:TemplateField Visible="true">
										...
										<ItemTemplate>
											<asp:CheckBox Checked='<%# GetStatusChecked(Eval("DCAS_SUPP_DECISION")) %>' runat="server" ID="chkBoxActive" />
										</ItemTemplate>
									</asp:TemplateField>
